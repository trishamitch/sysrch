...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt_update = $conn->prepare("UPDATE users SET fname = ?, mname = ?, lname = ?, age = ?, gender = ?, number = ?, address = ? WHERE idno = ?");
    $stmt_update->bind_param("sssssssi", $fname, $mname, $lname, $age, $gender, $number, $address, $_SESSION['idno']);
